...
\textless~Cybersecurity~\textgreater\\
...
% affiliations
\author{\IEEEauthorblockN{Costa Alves Nelson}
\IEEEauthorblockA{University of Luxembourg\\
Email: nelson.costa.001@student.uni.lu}
\\
{\bf This report has been produced under the supervision of:}\\
\IEEEauthorblockN{Ries Benoît}
\IEEEauthorblockA{University of Luxembourg\\
...
This template is to be used using the Latex document preparation system or using any document preparation system. The whole document should be 2000 words ($\pm$ 20\%) for S2 to S6 students and 3000 words ($\pm$ 20\%) for S1 students (excluding the annexes) and the proportions must be preserved. The other documents to be delivered (summaries, \ldots) should have their format adapted from this template.\\
...
Almost every aspect of our lives, from personal communication and financial transactions to critical infrastructure and government operations, is now digital. Because of our growing reliance on technology as a result of rising digitization, cybersecurity is crucial to maintaining the availability and integrity of these systems. This Bachelor Semester Project aims to show why it is imperative and in everyone's best interest to have sophisticated cyber defense plans and methods in place to protect the data. Every member of society depends on essential infrastructure, including power plants, hospitals, and other healthcare facilities. These are necessary for our society to function.
...
{\it This 350 words section without this first paragraph must be included in the submitted report and placed after the references section. This section is not counting in the total words quantity.}\\
